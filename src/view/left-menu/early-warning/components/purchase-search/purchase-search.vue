    ...
    <section class="assign-search">
        ...
        <Row>
            <i-col span="24" class="type">
                ...
                <!-- <div v-if='label="农产品采收提醒"'> -->
                    <section style="margin:18px 0;" v-if='label=="农产品采收提醒"'>
                        <section class="type-title">
                            预计采收日期
                        </section>
                        <section class="type-select">
                    ...
                    <section style="margin:18px 0;" v-if='label=="农产品库存预警"'>
                        <section class="type-title">
                            农产品名称
                        </section>
                        <section class="type-select">
                    ...
                    <section class="type-btn" style="margin:18px 0;">
                        ...
                        <i-button type="primary" shape="circle" class="type-btn-c" size="small" v-if='label=="农产品采收提醒"'>重置</i-button>
