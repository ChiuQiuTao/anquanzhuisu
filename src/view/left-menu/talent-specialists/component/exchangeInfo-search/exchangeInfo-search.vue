    ...
    <Row>
      <i-col span="24" class="type">
        <section style="margin:18px 0;">
          <section class="type-title">发布人</section>
          <section class="type-select">
            <i-input size="small" placeholder style="width: 90px"></i-input>
          </section>
        </section>

        <section style="margin:18px 0;">
          <section class="type-title">关键字</section>
          <section class="type-select">
            <i-input size="small" placeholder style="width: 90px"></i-input>
          </section>
        </section>
        ...
        <section style="margin:18px 0;">
          <section class="type-title">发布日期</section>
          <section class="type-select">
            <row>
              <i-col span="12">
                <Date-picker
